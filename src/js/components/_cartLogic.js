...
document.addEventListener('DOMContentLoaded', () => {
	...
	const modal = new GraphModal({
      ...
      document.querySelector(".order-modal__number").textContent = `Номер заказа ${randomId++}`;
    ...
    const userNameErrorOrder = document.getElementById("userNameErrorOrder");
    const userTelErrorOrder = document.getElementById("userTelErrorOrder");
    const userMailErrorOrder = document.getElementById("userMailErrorOrder");

    if (name === "" || tel === "" || mail === "") {
      if (name === "") userNameErrorOrder.style.display = "block";
      else userNameErrorOrder.style.display = "none";
      if (tel === "") userTelErrorOrder.style.display = "block";
      else userTelErrorOrder.style.display = "none";
      if (mail === "") userMailErrorOrder.style.display = "block";
      else userMailErrorOrder.style.display = "none";
    } else {
      userNameErrorOrder.style.display = "none";
      userTelErrorOrder.style.display = "none";
      userMailErrorOrder.style.display = "none";
